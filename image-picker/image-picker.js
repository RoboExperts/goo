  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      ...
      this.node = jQuery("<li/>");
				...
				// plusButton='<span class="QteCalcul" data-type="Minus"  id="Minus'+this.value()+'" data-id="qtprod'+this.value()+'" data-select-id="'+this.option.data("select-id")+'" data-tabnbre="'+this.option.data("tabnbre")+'" data-value="'+this.value()+'"  style="cursor: pointer"><span class="glyphicon glyphicon-minus"></span></span>';
				// minusButton='<span class="QteCalcul" data-type="Plus" id="Plus'+this.value()+'"  data-id="qtprod'+this.value()+'" data-max="'+this.option.data("qte")+'" data-tabnbre="'+this.option.data("tabnbre")+'"  data-value="'+this.value()+'"  data-select-id="'+this.option.data("select-id")+'" style="cursor: pointer"><span class="glyphicon glyphicon-plus"></span></span>'  
		  // }
		...
		'+plusButton+'\
		  ...
		  thumbnail.click({
			...
			return event.data.option.clicked();
			  ...
			  // jQuery('#PopBoxClick'+this.value()).click({
				// option: this
			  // }, function(event) {
				// return event.data.option.clicked();
			  // });
